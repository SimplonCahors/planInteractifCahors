...
function GetInfoCategory(data) {
    ...
    data.forEach(function (element) {
        ...
        name.innerHTML = '<i class="material-icons up">expand_less</i>' + '<i class="material-icons down">expand_more</i>' + element.name;
...
function removeMarker(sub, parent) {
    ...
    oldMarkers.forEach(function (element) {
        toRemove.forEach(function (nameElem) {
    ...
    idToRemove.forEach(function (id) {
